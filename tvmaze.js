...
async function getShowsByTerm(term) {
  ...
  const response = await axios({baseURL: "http://api.tvmaze.com/", url: "search/shows",method: "GET",
    params: {
      q: term
    },
  });
...
async function getEpisodesOfShow(id) { 
  const res = await axios({baseURL: "http://api.tvmaze.com/", url: `shows/${id}/episodes`, method: "GET"});
